...
# 1. Program call through bash-CLI.
# 2. Building linked lists.
# 3. Running the linked list.

# Input variables:
# filenames list <form id="thelist">
# starts list <form id="thestarts">
# steps int <form id="steps">
...
def preLexer():
	try:
		...
		#steps = document.getElementById("stepNr").value
	except:
		pass
	try:
...
######
	...
	#Types of continuations of the sides[1] string:
